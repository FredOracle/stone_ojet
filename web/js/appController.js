     ...
     function ControllerViewModel() {
      ...
      self.mdScreen = oj.ResponsiveKnockoutUtils.createMediaQueryObservable(mdQuery);
       ...
       self.router.configure({
         ...
         'policies': {label: 'NBox'},
         'pages': {label: 'Pages'},
         'advancededitable': {label: 'Advanced Editable'},
         'about': {label: 'About'},
         'recordertile': {label: 'RecorderTile'},
      ...
      {name: 'NBox', id: 'policies',
       iconClass: 'oj-navigationlist-item-icon demo-icon-font-24 demo-people-icon-24'},
      {name: 'Pages', id: 'pages',
       iconClass: 'oj-navigationlist-item-icon demo-icon-font-24 demo-people-icon-24'},
      {name: 'Advanced Editable', id: 'advancededitable',
       iconClass: 'oj-navigationlist-item-icon demo-icon-font-24 demo-people-icon-24'},
      {name: 'About', id: 'about',
       iconClass: 'oj-navigationlist-item-icon demo-icon-font-24 demo-info-icon-24'},
     {name: 'RecorderTile', id: 'recordertile',
       iconClass: 'oj-navigationlist-item-icon demo-icon-font-24 demo-info-icon-24'},
      {name: 'Hierarchical', id: 'hierarchical',
       iconClass: 'oj-navigationlist-item-icon demo-icon-font-24 demo-info-icon-24'}
      ];
